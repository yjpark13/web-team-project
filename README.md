...
![Landing](image/readme.image/landing-page.jpg)

#### 설명

프로젝트의 시작 페이지로 유럽 여행 사이트의 메인 화면을 구성했습니다.

- 유럽 여행 콘셉트의 랜딩 페이지 제작
- 국가별 여행 페이지 이동 기능 구현
- Start Your Journey 버튼을 통해 메인 페이지 이동
- 여행 경로(Amsterdam → London → Rome → Berlin → Madrid) 시각화
- FAQ 바로가기 메뉴 추가
- 유럽 지도 배경을 활용한 디자인 적용

---

### 4-2. Main Page

![Main](image/readme.image/main-page.jpg)

#### 설명

- 국가별 여행 정보를 선택할 수 있는 메인 페이지입니다.
- 각 국가 페이지로 이동할 수 있습니다.
- FAQ 페이지로 이동하여 자주 묻는 질문과 여행 팁을 확인할 수 있습니다.

---

### 4-3. Header

![Header](image/readme.image/header-page.jpg)
...
![United Kingdom](image/readme.image/uk-page.jpg)
...
![Italy](image/readme.image/italy-page.jpg)
...
![Germany](image/readme.image/germany-page.jpg)
...
![Spain](image/readme.image/spain-page.jpg)
...
![FAQ](image/readme.image/faq-page.jpg)
